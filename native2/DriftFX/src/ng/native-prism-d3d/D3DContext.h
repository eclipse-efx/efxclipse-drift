...
#ifndef DRIFTFX_INTERNAL_PRISM_JAVA8_D3DCONTEXT_H_
#define DRIFTFX_INTERNAL_PRISM_JAVA8_D3DCONTEXT_H_
	...
	namespace internal {
		namespace prism {
			namespace java8 {
				...
				const unsigned int NUM_TEXTURE_CACHE = 8;
...
#endif /* DRIFTFX_INTERNAL_PRISM_JAVA8_D3DCONTEXT_H_ */
